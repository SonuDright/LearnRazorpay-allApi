...
CostomerGetModel costomerGetModelFromJson(String str) => CostomerGetModel.fromJson(json.decode(str));

String costomerGetModelToJson(CostomerGetModel data) => json.encode(data.toJson());

class CostomerGetModel {
  String? entity;
  int? count;
  List<Item>? items;
  ...
  factory CostomerGetModel.fromJson(Map<String, dynamic> json) => CostomerGetModel(
    entity: json["entity"],
    count: json["count"],
